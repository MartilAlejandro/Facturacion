   ...
   Scanner Entrada = new Scanner(System.in);
     ...
     cantidadProductos = ArchivoProductos.cargarProductos(productos);
      ...
      System.out.println("=========================================");
        switch(Smenu){
        case 1:
        System.out.println("Nueva Factura"); // Pendiente de implementar
        break;
        case 2:
        System.out.println("Buscar factura"); // Pendiente de implementar
        break;
        case 3:
        System.out.println("Anular factura"); // Pendiente de implementar
        break;
        case 4:
        System.out.println("facturas del dia"); // Pendiente de implementar
        break;
         case 5:
        System.out.println("facturas por fechas"); // Pendiente de implementar
        break;
        case 6:
        System.out.println("devoluciones"); // Pendiente de implementar
        break;
        case 7:
